...
Router.prototype.build = function build(to, params) {
  var route = this.isAbsolutePath(to) ? this.getRoute(to) : this.getRouteById(to);
  var pattern = this._patterns[route.id];

  console.log(pattern.reverse, pattern.match);
