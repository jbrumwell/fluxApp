...
var ReduceStore = (function (_BaseStore) {
  _inherits(ReduceStore, _BaseStore);

  function ReduceStore() {
    _classCallCheck(this, ReduceStore);

    _get(Object.getPrototypeOf(ReduceStore.prototype), 'constructor', this).apply(this, arguments);
  }
