...
module.exports = {
  ...
  componentWillMount: function componentWillMount() {
    ...
    if (this.actions) {
      Object.keys(this.actions).forEach(function iterateAction(method) {
        self.bindActions(self.actions[ method ], self[ method ]);
      });
    ...
    if (this.stores) {
      Object.keys(this.stores).forEach(function iterateAction(method) {
        self.bindStores(self.stores[ method ], self[ method ]);
      });
    }
  },
  ...
  componentWillUnmount: function componentWillUnmount() {
    ...
    if (this.stores) {
      Object.keys(this.stores).forEach(function iterateAction(method) {
        self.unbindStores(self.stores[ method ], self[ method ]);
      });
    }
  },
  ...
  onDispatch: function onDispatch(payload) {
    if (this.isMounted() && this._actionMapper[ payload.actionType ]) {
      this._actionMapper[ payload.actionType ](payload);
    }
  }
};
