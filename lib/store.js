...
var BaseStore = (function (_EventEmitter) {
  ...
  */
  ...
  _createClass(BaseStore, [{
    ...
    key: '_getDispatchedEvent',
    value: function _getDispatchedEvent() {
      var Dispatcher = this.context.getDispatcher();
    ...
    value: function listenTo(actionType, method) {
      ...
      actionType = actionType !== '*' ? (0, _utilNamespaceTransform2['default'])(actionType) : actionType;
    ...
    */
    ...
    value: function _processActionEvent(payload) {
      ...
      return _bluebird2['default'].resolve(result).tap(function () {
        var sendWildcard = payload.actionType !== '*' && _this2._hasCatchall();

        return sendWildcard ? _this2._processActionEvent({
          actionType: '*',
          payload: payload
        }) : null;
      });
    ...
    */
    ...
    key: 'emitChange',
    value: function emitChange(actionType) {
