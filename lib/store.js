  ...
  _createClass(BaseStore, [{
    ...
    value: function _initActions() {
      ...
      _lodash2['default'].each(_lodash2['default'].keys(actions), function (method) {
        ...
        value.forEach(function (name) {
          name = (0, _utilNamespaceTransform2['default'])(name);

          _this._actionTypes[name] = method;
        });
      });
    }
    ...
    */
    ...
    value: function setState(state, noEvent) {
      ...
      var isEqual = _lodash2['default'].isEqual(currentState, state);
    ...
    */
    ...
    value: function replaceState(state, noEvent) {
      var isEqual = _lodash2['default'].isEqual(this.getMutableState(), state);
