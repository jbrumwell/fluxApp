  ...
  */
  ...
  _createClass(BaseActions, [{
    ...
    */
    ...
    key: '_dispatchFailed',
    value: function _dispatchFailed(namespace, err) {
      return this.dispatcher.dispatch({
    ...
    value: function _invokeAction(method, handler) {
      ...
      if (pending) {
        actionDispatch = response.then(this._dispatchAction.bind(this, actionType)).then(this._dispatchAfter.bind(this, namespace))['catch'](this._dispatchFailed.bind(this, namespace));
