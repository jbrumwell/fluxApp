  ...
  _createClass(BaseActions, [{
    ...
    */
    ...
    value: function _dispatchFailed(namespace, args, error) {
      ...
      var type = arguments.length <= 3 || arguments[3] === undefined ? 'unknown' : arguments[3];
    ...
    value: function _invokeAction(method, handler) {
      ...
      return _bluebird2['default'].resolve().tap(function () {
        ...
        return _this3._dispatchFailed(namespace, args, err, 'before');
      })['catch'](_errors.ActionDispatchError, function (err) {
        return _this3._dispatchFailed(namespace, args, err, 'action');
      })['catch'](_errors.ListenerDispatchError, function (err) {
        return _this3._dispatchFailed(namespace, args, err, 'listener');
      })['catch'](_errors.AfterDispatchError, function (err) {
        return _this3._dispatchFailed(namespace, args, err, 'after');
        ...
        return _this3._dispatchFailed(namespace, args, err, 'unknown');
      });
    }
